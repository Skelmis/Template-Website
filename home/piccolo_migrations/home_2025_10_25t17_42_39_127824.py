...
from piccolo.columns.column_types import Boolean, Serial
...
async def forwards():
    ...
    manager.add_column(
        table_class_name="Users",
        tablename="users",
        column_name="auths_without_password",
        db_column_name="auths_without_password",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": False,
